...
(function() { this.JST || (this.JST = {}); this.JST["header"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="main-header group">\n  <div id="header-container">\n    <a href="#">\n      <img class="help-logo" src="/assets/help-logo.png">\n    </a>\n\n    <form class="header-search">\n      <label class="main-search">\n        <span class="pseudo-input">Find</span>\n        <input\n          type="text"\n          class="query"\n          name="search[input]"\n          placeholder="restaurants near a/A">\n      </label>\n      <button class="submit-search">\n        <img src="/assets/magnifying-glass.png">\n      </button>\n    </form>\n\n    <div class="header-nav">\n      <ul class="nav-list">\n        <li>\n          <a href="#">Home</a>\n        </li>\n        <li>\n          ');  if (currentUser.isSignedIn()) { ; __p.push('\n            <a href="#/users/',  currentUser.id ,'">About Me</a>\n          ');  } else { ; __p.push('\n            <a href="#/session/new">About Me</a>\n          ');  } ; __p.push('\n        </li>\n        <li>\n          <a href="#/search" class="search-link">Write a Review</a>\n        </li>\n        <li>\n          <a class="new_restaurant_button" href="#/restaurants/new">Add a Restaurant</a>\n        </li>\n      </ul>\n    </div>\n  </div>\n\n  <div class="user_session">\n    ');  if (currentUser.isSignedIn()) { ; __p.push('\n      <a class="log-out-button" href="#/session/new">Log Out</a>\n    ');  } else { ; __p.push('\n      <ul class="user_session_list">\n        <li>\n          <a class="sign_up_button" href="#/users/new">Sign Up</a>\n        </li>\n        <li>\n          <a class="log_in_button" href="#/session/new">Log In</a>\n        </li>\n      </ul>\n    ');  } ; __p.push('\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["helpfulness/helpfulness"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<li class="helpfulness-button">\n  <button class="Useful">\n    Useful <span class="helpfulness-count">',  review.get('useful_count') ,'</span>\n  </button>\n</li>\n<li class="helpfulness-button">\n  <button class="Funny">\n    Funny <span class="helpfulness-count">',  review.get('funny_count') ,'</span>\n  </button>\n</li>\n<li class="helpfulness-button">\n  <button class="Cool">\n    Cool <span class="helpfulness-count">',  review.get('cool_count') ,'</span>\n  </button>\n</li>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["home"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2>Help App Academy</h2>\n\n<div class="recent-reviews-list">\n  <h1>Recent Activity</h1>\n\n  <ul class="recent-reviews"></ul>\n</div>\n\n<div class="da-space">\n  <a href="http://celadon.online">\n    <img class="celadon" src="/assets/celadonlogo.png">\n  </a>\n  <a href="http://www.cocktailist.club">\n    <img class="cocktail" src="/assets/cocktaillogo.png">\n  </a>\n  <a href="http://www.hackoverflow.xyz">\n    <img class="hackoverflow" src="/assets/hackoverflow.png">\n  </a>\n  <a href="http://www.domio.xyz">\n    <img class="domio" src="/assets/domio-logo.png">\n  </a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["photos/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="preview"></div>\n\n<form class="upload-restaurant-image">\n  <input type="file" name="photo[image]" id="input-image">\n  <button>Submit</button>\n</form>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["restaurants/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="restaurant-new">\n  <div class="restaurant-new-container">\n    <h1>Add a Restaurant</h1>\n    <h2>And let the reviews begin...</h2>\n\n    <input type="text" name="restaurant[name]" placeholder="Name">\n    <input type="text" name="restaurant[street_address]" placeholder="Street Address">\n    <input type="text" name="restaurant[city_zipcode]" placeholder="City Zipcode">\n\n    <button class="add-restaurant">Add Restaurant</button>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["restaurants/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="top-shelf">\n  <div class="restaurant group">\n    <p class="restaurant-name">',  restaurant.escape("name") ,'</p>\n    <div id="restaurant-average-rating"></div>\n    <div class="restaurant-tags">\n      <ul class="restaurant-tags-list"></ul>\n      <a class="new-tag" href="#/restaurants/',  restaurant.id ,'">\n        Add a Tag\n      </a>\n    </div>\n\n    <div class="map-container">\n      <div id="map"></div>\n      <div class="restaurant-map-info">\n        <div class="address">\n          ',  restaurant.escape("street_address") ,'\n          <br>\n          ',  restaurant.escape("city_zipcode") ,'\n        </div>\n        <a id="directions-link" href="#/restaurants/',  restaurant.id ,'">\n          Get Directions\n        </a>\n      </div>\n    </div>\n\n    <div class="top-shelf-buttons">\n      <ul>\n        <li>\n          <a\n            class="new-review"\n            href="#/restaurants/',  restaurant.id ,'/reviews/new">\n            Write a Review\n          </a>\n        </li>\n        <li>\n          <a\n            class="new-photo"\n            href="#/restaurants/',  restaurant.id ,'/photos/new">\n            Add a Photo\n          </a>\n        </li>\n      </ul>\n    </div>\n\n    <div class="restaurant-photos">\n      <ul class="restaurant-photos-list"></ul>\n    </div>\n  </div>\n</div>\n\n<div class="reviews-view">\n  <div class="reviews">\n    <h1>Recommended Reviews</h1>\n    <ul class="reviews-list group"></ul>\n  </div>\n</div>\n\n<div class="map-directions-container">\n  <div class="modal-container">\n    <div class="modal-screen hide"></div>\n    <div class="modal-map hide">\n      <div class="close-button">x</div>\n      <div id="map-directions"></div>\n      <div id="map-panel"></div>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/home_list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="home-reviewer">\n  <div class="home-reviewer-avatar-container">\n    <img src="',  user.escape('avatar_url') ,'" class="home-reviewer-avatar">\n  </div>\n\n</section>\n\n<section class="home-review-body group">\n  <div class="home-reviewer-name-container">\n    <a class="home-reviewer-name" href="#/users/',  user.id ,'">\n      ',  user.escape('first_name') ,' ',  user.escape('last_name') ,'\n    </a>\n    wrote a review for\n    <a class="home-restaurant-name" href="#/restaurants/',  restaurant.id ,'">\n      ',  restaurant.escape('name') ,'\n    </a>\n  </div>\n\n  <div class="home-time-ago">\n    <time datetime="',  review.get('updated_at') ,'" class="age"></time>\n    <script type="text/javascript">\n      $(\'.age\').age();\n    </script>\n  </div>\n\n  <div id="home-star-rating"></div>\n\n  ',  review.escape("body") ,'\n  <div class="review-helpfulness">\n    <p class="review-helpfulness-q">Was this review ...?</p>\n    <ul class="review-helpfulness-buttons"></ul>\n  </div>\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<section class="reviewer">\n  <div class="reviewer-avatar-container">\n    <img src="',  user.escape('avatar_url') ,'" class="reviewer-avatar">\n  </div>\n\n  <div class="reviewer-name">\n    <a href="#/users/',  user.id ,'">\n      ',  user.escape('first_name') ,' ',  user.escape('last_name') ,'\n    </a>\n  </div>\n</section>\n\n<section class="review-body">\n  <div id="star-rating"></div>\n\n  <div class="time-ago">\n    <time datetime="',  review.get('updated_at') ,'" class="age"></time>\n    <script type="text/javascript">\n      $(\'.age\').age();\n    </script>\n  </div>\n\n  ',  review.escape("body") ,'\n</section>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="new-review-content-container group">\n  <div class="new-review-content">\n    <h1>Write a Review</h1>\n    <a href="#/restaurants/',  restaurant.id ,'">\n      ',  restaurant.escape("name") ,'\n    </a>\n    <br>\n    <div class="new-reivew-address">\n      ',  restaurant.escape("street_address") ,'\n      ',  restaurant.escape("city_zipcode") ,'\n    </div>\n\n    <h3>Your review</h3>\n    <form class="new-review-form">\n      <div id="star-rate"></div>\n      <textarea name="review[body]"\n        placeholder="Your review will help your fellow App Academy students know which restaurants are bad and which are worse."></textarea>\n\n      <button class="post-review">Post Review</button>\n    </form>\n  </div>\n\n  <div class="new-review-example-container">\n    <h1>Reviews for ',  restaurant.escape("name") ,'</h1> \n    <ul class="new-review-example-list"></ul>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["search/list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="search-item">\n  <a href="#/restaurants/',  result.id ,'">\n    ',  result.escape("name") ,'\n  </a>\n  <div class="average-restaurant-rating"></div>\n\n  <a href="#/restaurants/',  result.id ,'/reviews/new" class="new-review">\n    Write a Review\n  </a>\n</div>\n\n<p class="search-address">\n  ',  result.escape("street_address") ,'\n  <br>\n  ',  result.escape("city_zipcode") ,'\n</p>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["search/search"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="search-top-shelf">\n\t<div class="search-heading-container group">\n\t\t<div class="search-form">\n\t\t\t<h1>Your next rant awaits</h1>\n\n\t\t\t<p>\n\t\t\t\tReview everything from your favorite burger to the heated conversation you\n\t\t\t\thad with your friends about how many black shirts Jonathan has.\n\t\t\t</p>\n\n\t\t\t<form class="search">\n\t      <label class="main-search">\n\t        <span class="pseudo-input">Find</span>\n\t        <input\n\t          type="text"\n\t          class="query"\n\t          name="search[input]"\n\t          placeholder="restaurants near a/A">\n\t      </label>\n\t      <button class="submit-search">\n\t        <img src="/assets/magnifying-glass.png">\n\t      </button>\n\t    </form>\n\t\t</div>\n\n\t\t<div class="app-academy-logo">\n\t\t\t<img src="/assets/app-academy-logo.png">\n\t\t</div>\n\t</div>\n</div>\n\n<div class="results-view hide group">\n\t<div class="results-search-container">\n\t\t<section class="results">\n\t\t\t<h2>See the business you\'d like to review?</h2>\n\t\t\t<button class="sort-by-rating">Highest Rated</button>\n\t\t\t<button class="sort-by-reviews">Most Reviewed</button>\n\t\t\t<ul class="results-list"></ul>\n\n\t\t\t');  if (results.total_count > 0) { ; __p.push('\n\t\t\t\t<nav class="page-count">\n\t\t\t\t\tDisplaying ',  results.total_count ,' out\n\t\t\t\t\tof ',  results.total_count ,' results\n\n\t\t\t\t\t<!-- ');  if (results.pageNum > 1) { ; __p.push('\n\t\t\t\t\t\t<a class="prev-page" href="javascript:void(0)">Prev</a>\n\t\t\t\t\t');  } ; __p.push('\n\n\t\t\t\t\t');  if (results.pageNum < results.total_count) { ; __p.push('\n\t\t\t\t\t\t<a class="next-page" href="javascript:void(0)">Next</a>\n\t\t\t\t\t');  } ; __p.push(' -->\n\t\t\t\t</nav>\n\t\t\t');  } ; __p.push('\n\t\t</section>\n\n\t\t<div id="search-map"></div>\n\t</div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["session/sign_in"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="sign_in_page group">\n  <div class="log_in_wrapper">\n\n    <form class="sign_in">\n      <h1>Log In</h1>\n      <p class="log_in_instructions">\n        Please enter your email address and password to log in.\n      </p>\n\n        <p>\n          <label class="log_in_label">Email Address</label>\n          <input type="text" name="user[email]">\n        </p>\n\n        <p>\n          <label class="log_in_label">Password</label>\n          <input type="password" name="user[password]">\n        </p>\n\n        <p class="button">\n          <button class="sign_in_button">Log In</button>\n        </p>\n\n        <p class="legal">\n          By logging in you agree that Help has helped.\n        </p>\n    </form>\n  </div>\n\n  <div class="no_account_wrapper">\n    <div class="no_account_width">\n      <h1>No Account Yet?</h1>\n      <p>\n        That\'s okay, we don\'t love you but you can still join.\n      </p>\n\n      <a href="#/users/new">Sign Up</a>\n\n      <p class="help-description">\n        Help is the fun and easy way to find, review, and talk about what\'s great\n        - and not so great - in your local NY App Academy area. It\'s about real\n        App Academy students giving their honest and personal opinions on lunch\n        places near App Academy.\n      </p>\n    </div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["taggings/list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="">',  tag.escape('tag') ,'</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["taggings/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<input type="text" name="tagging[tag]">\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="new_user_page group">\n  <div class="sign_up_wrapper group">\n\n    <div class="sign-up-form-top">\n      <h1> Sign Up for Help</h1>\n      <p class="rushed-lunch">Connect with a rushed lunch</p>\n\n      <a class="omniauth" href="/auth/facebook">Sign Up with Facebook</a>\n\n      <p class="disclaimer">\n        Don\'t worry, we always post without your permission.\n      </p>\n    </div>\n\n    <form>\n        <ul>\n          <div class="name group">\n            <li class="first_name">\n              <input\n                type="text"\n                name="user[first_name]"\n                placeholder="First Name">\n            </li>\n            <li class="last_name">\n              <input type="text" name="user[last_name]" placeholder="Last Name">\n            </li>\n          </div>\n\n          <li>\n            <input type="text" name="user[email]" placeholder="Email">\n          </li>\n          <li>\n            <input type="password" name="user[password]" placeholder="Password">\n          </li>\n        </ul>\n\n        <p class="legal">\n          By creating an account, you agree to Help\'s Terms of Service, that is,\n          you agree that Help has helped.\n        </p>\n\n        <button class="sign-up">Sign Up</button>\n\n        <p class="has-account">\n          Already on Help? <a href="#/session/new">Log In</a>\n        </p>\n    </form>\n  </div>\n\n  <div class="app-academy-logo-sign-up">\n    <img src="/assets/app-academy-logo.png">\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["users/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h2 class="user-show-name">\n  ',  user.escape("first_name") ,' ',  user.escape("last_name") ,'\n</h2>\n\n<img src="',  user.escape('avatar_url') ,'" class="profile-avatar">\n\n<div class="preview"></div>\n\n<form class="upload-avatar">\n  <input type="file" name="user[avatar]" id="input-image">\n  <button>Submit</button>\n</form>\n');}return __p.join('');};
}).call(this);
...
YelpClone.Collections.Helpfulness = Backbone.Collection.extend({
  model: YelpClone.Models.Helpfulness,
  url: '/api/helpfulnesses'
});
...
YelpClone.Collections.SearchResults = Backbone.Collection.extend({
	url: "/api/search",
	...
	model: function (attrs) {
		...
		return new YelpClone.Models[type](attrs);
	}
});
...
YelpClone.Routers.Router = Backbone.Router.extend({
  routes: {
    ...
    'restaurants/:restaurant_id/photos/new': 'photoNew',
    'users/new': 'usersNew',
    'users/:id': 'usersShow',
    'session/new': 'signIn',
    'search' : 'search'
  ...
  photoNew: function(restaurant_id) {
    var restaurant = this.restaurantCollection.getOrFetch(restaurant_id);
    var model = new YelpClone.Models.Photo({ restaurant_id: restaurant_id });
    var view = new YelpClone.Views.PhotosForm({
      model: model,
      restaurant: restaurant
    });
    this._swapView(view);
