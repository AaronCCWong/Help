...
(function() { this.JST || (this.JST = {}); this.JST["restaurants/new"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<label>Name</label>\n<input type="text" name="restaurant[name]">\n<br>\n\n<label>Address</label>\n<input type="text" name="restaurant[street_address]">\n<input type="text" name="restaurant[city_zipcode]">\n<br>\n\n<label>Tags (separate each tag by an empty space)</label>\n<div class="tags">\n  <input type="text" name="taggings[tag]">\n</div>\n\n<button class="add-restaurant">Add Restaurant</button>\n');}return __p.join('');};
}).call(this);
