...
(function() { this.JST || (this.JST = {}); this.JST["restaurants/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  restaurant.escape("name") ,'\n<br>\n',  restaurant.escape("address") ,'\n<a href="#/restaurants/',  restaurant.id ,'/reviews/new">Write a Review</a>\n\n<ul class="reviews"></ul>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["reviews/list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<p>\n  ',  review.escape("body") ,'\n</p>\n');}return __p.join('');};
}).call(this);
