...
(function() { this.JST || (this.JST = {}); this.JST["taggings/list_item"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('',  tag.escape('tag') ,'\n');}return __p.join('');};
}).call(this);
